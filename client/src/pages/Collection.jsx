...
export default function Collection() {
  ...
  const collHints = useMemo(() => [
    ...
    { id: 'coll_sidebar_search', position: 'bottom', title: 'Filter your sets', body: 'Type a year or product name here to jump straight to a specific set without scrolling through the whole list.' },
